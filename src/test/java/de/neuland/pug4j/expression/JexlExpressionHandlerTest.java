...
public class JexlExpressionHandlerTest {
  ...
  public void testMapMulti() throws ExpressionException {
    jexlExpressionHandler.evaluateExpression(
        "var map = {"
            + "  'text': 'text',"
            + "  'image': 'image.jpg',"
            + "  'button' : {"
  ...
  public void testBlockNodeAccess() throws ExpressionException {
    ...
    Object o =
        jexlExpressionHandler.evaluateExpression(
            "pug4j__block.execute(pug4j__writer,pug4j__model,pug4j__template)", pugModel);
  ...
  public void testAntishObjectAccess() throws ExpressionException {
    ...
    final String value =
        jexlExpressionHandler.evaluateStringExpression("level1.level2.name", pugModel);
    assertEquals("value", value);
  }
}
