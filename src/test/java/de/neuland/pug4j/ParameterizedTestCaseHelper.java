...
public class ParameterizedTestCaseHelper {
  ...
  public ParameterizedTestCaseHelper(
  ...
  public PugConfiguration getPugConfiguration() {
    ...
    FileTemplateLoader fileTemplateLoader =
        new FileTemplateLoader(fileTemplateLoaderPath, extension);
  ...
  public String getActualHtml(
      String filename, PugConfiguration pugConfiguration, HashMap<String, Object> model)
      throws IOException {
