...
public class ArgumentSplitterTest {
  ...
  @Test
  public void shouldRecognizeNumberOfParametersWhenUsingDoubleQuotesAndSingleQuotes()
      throws Exception {
  ...
  @Test
  public void shouldRecognizeDoubleQuotedParameterWhenUsingDoubleQuotesAndSingleQuotes()
      throws Exception {
    whenSplitting("\"bla\",'blub',\"boo, hoo\"");
  ...
  @Test
  public void shouldRecognizeSingleQuotedParametersWhenUsingDoubleQuotesAndSingleQuotes()
      throws Exception {
    whenSplitting("\"bla\",'blub',\"boo, hoo\"");
