...
public class PugTemplate {
  ...
  /**
   * Renders this template with the given model, render context, and engine. This is the new API
   * (3.0+) where templates render themselves.
   *
   ...
   */
  public void render(
      Map<String, Object> model, RenderContext context, PugEngine engine, Writer writer)
      throws PugCompilerException {
    if (model == null) {
