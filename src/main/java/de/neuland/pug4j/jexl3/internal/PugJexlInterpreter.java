...
public class PugJexlInterpreter extends Interpreter {
  protected PugJexlInterpreter(
      final Engine engine, final JexlOptions opts, final JexlContext aContext, final Frame eFrame) {
  ...
  protected Object visit(ASTReference node, Object data) {
    ...
    for (int c = 0; c < numChildren; ++c) {
      ...
      if (childNode instanceof ASTMethodNode
          && node.jjtGetChild(0) != childNode
