...
public class AttributesCompiler {
  ...
  private void addAttributesBlockToAttributesList(
      final PugModel model,
      final AttrsNode node,
      final String attributeBlockExpression,
      final LinkedList<Attr> newAttributes) {
  ...
  private Map<String, String> attrs(
      PugModel model, final AttrsNode node, LinkedList<Attr> attrs, boolean terse) {
    ...
    for (Attr attribute : attrs) {
      createAttributeValues(
          normalAttributes, classes, classEscaping, attribute, model, node, terse);
    }
  ...
  private String renderClassList(
      final ArrayList<String> classes, final ArrayList<Boolean> classEscaping) {
  ...
  private void createAttributeValues(
      ...
      ArrayList<Boolean> classEscaping,
      Attr attribute,
      PugModel model,
      final AttrsNode node,
      boolean terse) {
  ...
  private void addClassValueToClassArray(
      final ArrayList<String> classes,
      final ArrayList<Boolean> classEscaping,
  ...
  private Object evaluateExpression(
      ExpressionString attribute, PugModel model, final AttrsNode node) {
