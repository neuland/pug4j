...
public class Pug4J {
  ...
  private static PugTemplate getTemplate(String filename, PugConfiguration pugConfiguration)
      throws IOException {
    if (filename == null) {
  ...
  private static PugTemplate getTemplate(
      Reader reader, String name, PugConfiguration pugConfiguration) throws IOException {
  ...
  private static PugTemplate createTemplate(String filename, PugConfiguration pugConfiguration)
      throws IOException {
    Parser parser =
        new Parser(
            filename,
  ...
  private static String templateToString(
      PugTemplate template, Map<String, Object> model, PugConfiguration pugConfiguration)
      throws PugCompilerException {
