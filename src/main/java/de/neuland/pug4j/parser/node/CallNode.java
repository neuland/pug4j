...
public class CallNode extends AttrsNode {
  ...
  public LinkedHashMap<String, Object> getMixinVariables(
      PugModel model,
      MixinNode mixin,
  ...
  /**
   * @deprecated Use getMixinVariables(PugModel, MixinNode, ExpressionHandler, TemplateLoader)
   *     instead
   */
  @Deprecated
  public LinkedHashMap<String, Object> getMixinVariables(
      PugModel model, MixinNode mixin, PugConfiguration configuration) {
    return getMixinVariables(
        model, mixin, configuration.getExpressionHandler(), configuration.getTemplateLoader());
  }
