...
public abstract class Node implements Cloneable {
  ...
  public boolean isTextNode(Node node) {
    return node instanceof TextNode
        ...
        || (node instanceof FilterNode && node.hasBlock() && node.getBlock().getNodes().size() > 0);
  }
  ...
  /**
   * Accept a visitor to process this node. This method implements the Visitor pattern to avoid
   * instanceof chains.
   *
